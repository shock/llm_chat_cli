...
def test_initialization():
    """Test the initialization of OpenAIChatCompletionApi."""
    api = OpenAIChatCompletionApi(api_key="test_api_key", model="4o-mini")
...
def test_initialization_invalid_model():
    ...
    with pytest.raises(ValueError):
        OpenAIChatCompletionApi(api_key="test_api_key", model="invalid_model")
